...
public class JavacConfigProvider {
    ...
    public static void setLatestSourceVersion(SourceVersion newVersion) {
        latestSourceVersion = Objects.requireNonNull(newVersion, "newVersion");
    }

    /**
     * Get the latest source version supported by the compiler.
     */
    ...
    public static void setLatestSupportedSourceVersion(SourceVersion newVersion) {
        latestSupportedSourceVersion = Objects.requireNonNull(newVersion, "newVersion");
    }
}
