...
/** * @author Mohammed-baqer-null @ https://github.com/Neeraj-OS-Developer */
class TomIDEUpdater(private val context: Context) {

  companion object {
    private const val TAG = "TomIDEUpdater"
    private const val UPDATE_JSON_URL =
        "https://raw.githubusercontent.com/Neeraj-OS-Developer/android-code-studio/refs/heads/dev/updater.json"
