 ...
 * Updated for Neeraj-OS-Developer official repository.
 */
...
const val GITHUB_API_REPO_URL =
    "${GITHUB_API_REPOS_URL}/Neeraj-OS-Developer/android-code-studio"

const val GITHUB_RAW_API_BASE_URL = "https://raw.githubusercontent.com"
const val GITHUB_RAW_API_REPO_URL =
    "${GITHUB_RAW_API_BASE_URL}/Neeraj-OS-Developer/android-code-studio"
