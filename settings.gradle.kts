...
dependencyResolutionManagement {
  val dependencySubstitutions = mapOf(
    ...
    "build-deps-common" to arrayOf(
      "desugaring-core"   // Provided by composite build, not listed in root include
    )
  )
...
gradle.rootProject {
    val appMainVersion = System.getenv("MAIN_VERSION") ?: "2.0.0"
    val revision = "r${System.getenv("REVISION_NUM") ?: "05"}"
    val baseVersion = "$appMainVersion+NS.$revision"
